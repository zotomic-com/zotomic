...
export const STRUCTURAL_META: Record<StructuralSlug, { label: string; route: string }> = {
  ...
  "web-development": { label: "Web Development", route: "/web-development" },
...
export const STRUCTURAL_DEFAULTS: Record<StructuralSlug, StructuralContent> = {
  ...
  "web-development": {
    ...blankStructural(),
    seoTitle: "Web Development & Design",
    seoDescription:
      "Custom website design and development from Zotomic — real portfolio work, packages with transparent pricing, and a straightforward process from brief to launch.",
    badge: "Custom Web Development",
    title: "Websites built to bring in customers",
    subtitle: "Not just a website — one designed and built to turn visitors into leads and sales.",
    itemsTitle: "What's included",
    items: [
      { icon: "Palette", title: "Custom design", text: "No templates. A site designed around your brand and the customers you're trying to reach." },
      { icon: "Smartphone", title: "Mobile-first & fast", text: "Built to load quickly and look right on every screen, from the first version." },
      { icon: "ShoppingCart", title: "E-commerce ready", text: "Product pages, cart, and checkout wired up from day one if you're selling online." },
      { icon: "Search", title: "Built for search & AI", text: "Clean structure and real content, so search engines and AI assistants can actually find you." },
    ],
    items2Title: "Questions",
    items2: [
      { icon: "", title: "How long does a project take?", text: "Most sites take 2-4 weeks from kickoff to launch, depending on scope." },
      { icon: "", title: "Do I own the code and design when it's done?", text: "Yes. Once the project is paid in full, the site and everything in it is yours." },
      { icon: "", title: "Is hosting included?", text: "We can host it for you, or hand it off to your own hosting — your choice." },
      { icon: "", title: "How many revisions do I get?", text: "Two full rounds of revisions are included in every package; more available if needed." },
    ],
    ctaEnabled: true,
    ctaTitle: "Have a project in mind?",
    ctaSubtitle: "Tell us what you're building — we'll get back to you within a day.",
  },
  about: {
    ...blankStructural(),
    seoTitle: "About",
