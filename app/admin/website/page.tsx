...
import { FileText, Palette, ListTree, Search, Tags, LayoutGrid, KeyRound, Settings2, ArrowRight, Store } from "lucide-react";
...
const SECTIONS = [
  ...
  {
    href: "/admin/website/storefronts",
    icon: Store,
    title: "Storefronts",
    text: "The homepage storefront carousel — mark a store Featured. Hot and New are automatic.",
  },
  {
