...
export default async function StoreRegisterPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-16 sm:px-6">
      <h1 className="mb-6 text-2xl font-extrabold tracking-tight">Create your account</h1>
      <AccountAuthClient slug={slug} basePath={basePath} mode="register" />
    </div>
  );
}
